...
class PublishPlatformPost implements ShouldQueue
{
    ...
    /**
     * The platform post instance.
     *
     * @var \App\Models\PlatformPost
     */
     ...
     *
     * @param \App\Models\PlatformPost $platformPost
     * @return void
     */
    public function __construct(PlatformPost $platformPost)
    {
    ...
    public function handle()
    {
        ...
        try {
            ...
            try {
                ...
                match ($provider) {
                    'facebook' => \App\Jobs\PostToFacebook::dispatchSync($this->platformPost),
                    'instagram' => \App\Jobs\PostToInstagram::dispatchSync($this->platformPost),
                    'x' => \App\Jobs\PostToX::dispatchSync($this->platformPost),
                    default => null
                };
